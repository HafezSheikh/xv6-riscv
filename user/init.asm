...
main(void)
{
  ...
  6e:	87e50513          	addi	a0,a0,-1922 # 8e8 <malloc+0x14c>
  ...
  b0:	80450513          	addi	a0,a0,-2044 # 8b0 <malloc+0x114>
  ...
  d2:	7fa50513          	addi	a0,a0,2042 # 8c8 <malloc+0x12c>
  d6:	00000097          	auipc	ra,0x0
  da:	2c8080e7          	jalr	712(ra) # 39e <exec>
      printf("init: exec sh failed\n");
  de:	00000517          	auipc	a0,0x0
  e2:	7f250513          	addi	a0,a0,2034 # 8d0 <malloc+0x134>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 44e:	4c650513          	addi	a0,a0,1222 # 910 <digits>
 452:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 51a:	3fab8b93          	addi	s7,s7,1018 # 910 <digits>
 ...
 65a:	2b290913          	addi	s2,s2,690 # 908 <malloc+0x16c>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7f8:	14c78793          	addi	a5,a5,332 # 940 <base>
 7fc:	00000717          	auipc	a4,0x0
 800:	12f73e23          	sd	a5,316(a4) # 938 <freep>
 804:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
